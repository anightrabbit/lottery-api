...
const checkActivityLimit = require('../middlewares/checkActivityLimit');
const checkMemberLuckyRecord = require('../middlewares/checkMemberLuckyRecord');
...
routes
	.route('/luckyDraw')
	.post(checkMemberAuth,// 先检查参与抽奖用户权限
		checkActivityDate, // 检查抽奖活动有效期
		checkFreeCode, // 检查参与用户渠道来源，是否需要消耗积分参与
		checkMemberDrawRecord, //检查用户抽奖记录
		checkActivityLimit, // 检查活动次数限制
...
routes
	...
	.post(checkMemberAuth,
		checkActivityDate,
		checkMemberDrawRecord,
		checkMemberLuckyRecord);
